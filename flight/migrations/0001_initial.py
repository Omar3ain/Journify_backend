    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('traveling_date', models.DateTimeField(validators=[django.core.validators.MinValueValidator(datetime.datetime(2023, 6, 27, 13, 23, 9, 359740, tzinfo=datetime.timezone.utc))], verbose_name='travelingDate')),
