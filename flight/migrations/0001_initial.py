    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('traveling_date', models.DateTimeField(validators=[django.core.validators.MinValueValidator(datetime.datetime(2023, 6, 25, 13, 38, 2, 662198, tzinfo=datetime.timezone.utc))], verbose_name='travelingDate')),
